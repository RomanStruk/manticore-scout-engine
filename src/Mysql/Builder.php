...
class Builder
{
     ...
     */
    public function autocomplete(array $allowOperators = ['*'], bool $stats = false, bool $foldWildcards = false, bool $foldLemmas = false, bool $foldBlended = false, ?string $sort = null): Builder
    {
        $type = 'Keywords';
        $options = [
            'stats' => intval($stats),
        ...
        $search = $this->grammar->escape($this->search, $allowOperators);
